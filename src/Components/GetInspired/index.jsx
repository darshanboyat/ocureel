...
const Index = () => {
  const videoId = [
    ...
    { id: "804748707", cardTitle: "A random question at a random time every day!", cardHead: "Daily Challenge!" },
    { id: "804757684", cardTitle: "NO FILTERS! NO HATE! ONLY POSITIVITY!", cardHead: "Reveal" }]
  return (
    <div className='get__inspired'>
      <Helmet>
        <title>Get Inspired</title>
        <meta name="description" content="Watch clips from users who have played our game." />
      </Helmet>
      <div className="caption">
        ...
        <p>We invite everyone to join us in this mission and see for themselves just how rewarding it can be to be SEEN and ACCEPTED for who you really are. </p>
      </div>
