  ...
  return (
    <>
      <div className={styles.header}>
        ...
        <p>We are committed to making Zecue an incredible experience for you! If you are having any trouble with our app, please give us the opportunity to help! Check out our Frequently Asked Questions below and if you still need more help, please email us at: support@zecue.com</p>
      </div>
      <div className={styles.container}>
        <div className={styles.section}>
          ...
          <Accordion title="Will I have to watch ads?">
            <p>We do have ads BUT don't worry! You will NEVER have to watch an ad if you don't want to. There are several features that you can unlock by watching an ad which helps us to keep Zecue running. </p>
          </Accordion>
          <Accordion title="What is the GIFT button?">
            <p>While watching a clip, the greatest complement you can give is a GIFT. By watching an ad you can help boost that user's video and you will both receive 25 additional points!</p>
          </Accordion>
          <Accordion title="Can I give more than 1 GIFT?">
            <p>You can give as many GIFTS as you want! By interacting with other user's videos you are contributing to make Zecue a stronger community. Make someones day and give them a GIFT!</p>
          </Accordion>
