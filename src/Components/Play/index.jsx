...
const TextContent = () => {
    ...
    const questions = [
        {
            title: "How do I play?",
            content: "Zecue guides the content you watch and record but ultimately, you get to CHOOSE YOUR ADVENTURE! What path will you take? You can Reveal, Freestyle, play the daily Challenge or LINK up with our 1-on-1 game."
        },
        {
            title: "Still scared?",
    ...
    return (
        <div className='play__container'>
              <Helmet
        title="Play"
        description="See how to play our one of a kind connection game."
      />
            <SnapScroll />
            <div className="play__card1">
                ...
                <div className="play__card1__section2">
                    ...
                    <p className='play__card1__section2__text__light'>Nobody likes being fake! Well… some people do and they might not like our game very much.</p>
                    <p className='play__card1__section2__patent'>Our <b>PATENT PENDING</b> game is designed to bring life and help you feel good about the time you spend on your phone. Zecue is the <b>ULTIMATE GAME of QUESTIONS.</b> Where you get to be YOU and nobody can hate on you or make you feel bad about it!</p>

                    <div className="play__card1__section2__story">
                        <p>On ZECUE, your <b>STORY</b> matters more than your <b>OPINION!</b> </p>
            ...
            <div className="play__card3">
                <div className="play__card3__section1">
                    ...
                    <div>
                        ...
                        <button className='play__card3__btn bg-black'><a href="/get-inspired" style={{ textDecoration: 'none', color: "white" }}>Get Inspired</a></button>
                    </div>
                </div>
                <div className="play__card3__section2">
                    <div className="play__card3__section2__header">
                        <h4>How do you earn points on Zecue?</h4>
                    ...
                    <div className="play__card3__points">
                        <div><BsCheckLg className='check__mark'/><p>As you play the game, you'll earn points for each clip you post!</p></div>

                        <div><BsCheckLg className='check__mark'/><p>Each question in the game is worth different points. The deeper you go, the more points you’ll earn! </p></div>
                        <div><BsCheckLg className='check__mark'/><p>On Zecue, your status is based off being real & authentic. and NOT how  good you look!</p></div>

                        <div><BsCheckLg className='check__mark'/><p>It's time to share YOU! Don’t be boring and just be a spectator, contribute to Zecue and play the game!!</p></div>

                        <div><BsCheckLg className='check__mark'/><p>Check out the Leaderboard to see how you can earn more points!</p></div>
                        <button className='play__card3__btn bg-black'><a href="/leaderboard" style={{ textDecoration: 'none', color: "white" }}>Leaderboard</a></button>
                    </div>
                </div>
            </div>
        </div>
